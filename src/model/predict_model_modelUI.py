...
def load_models():
    loaded_model = joblib.load('../model_artifacts/xgb_model_best.pkl')
    encodings = joblib.load('../model_artifacts/encodings.pkl')
...
def predict_model(json_data):
    ...
    best11 = [
        {"name": chosen_player_names[i], "score": chosen_players_scores[i]} for i in range(11)
    ]
